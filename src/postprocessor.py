...
# ═══════════════════════════════════════════════════════════════════════════
#  Validation stub — real implementation lives in test_contract_validator.py
# ═══════════════════════════════════════════════════════════════════════════

def run_contract_validation(code: str, doc: "ContractDocument"):
    """
    Stub: returns None when test_contract_validator.py is not present.
    The shell script runs the validator separately as a standalone step.
    """
    try:
        import sys, pathlib
        sys.path.insert(0, str(pathlib.Path(__file__).parent.parent))
        from test_contract_validator import validate_contract
        return validate_contract(code, doc)
    except ImportError:
        return None
