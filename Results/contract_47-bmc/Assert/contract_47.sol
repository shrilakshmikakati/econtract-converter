...
// =================================================================
// Contract : (P)           Material Contracts.
// Generated: 2026-04-20 08:37:23 UTC
...
contract MergerAgreement {
    ...
    uint256 public constant EFFECTIVE_DATE = 1631145600; // September 9, 2021
    uint256 public immutable startDate;
    string public constant GOVERNING_LAW = "Delaware";
    bool private _locked;
    address private _arbitrator;
    uint256 public constant TERM_DAYS = 45;
    ...
    function acknowledgeDelivery() external onlyParties {
        ContractState state = getContractState();
	assert(!(state != ContractState.Created));
	assert(!(!(state != ContractState.Created)));
        if (state != ContractState.Created) revert Unauthorized();
